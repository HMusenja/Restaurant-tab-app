  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? "bg-primary/10 text-foreground border-primary/25 shadow-sm dark:bg-primary/20 dark:text-[hsl(40,20%,95%)]"
...
export default function StaffRequestsPage() {
  ...
  useEffect(() => {
    // IMPORTANT: ACTIVE keeps IN_PROGRESS visible
    ...
    <div className="space-y-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge
              className={cn(
                ...
                "dark:bg-[hsl(40,20%,95%)/6%] dark:border-[hsl(40,20%,95%)/10%] dark:text-[hsl(40,10%,70%)]"
              )}
            >
              {count}
            </Badge>
      ...
      {loading && (
        <div
          className={cn(
            ...
            "dark:border-[hsl(40,20%,95%)/10%] dark:bg-[hsl(40,20%,95%)/4%] dark:text-[hsl(40,10%,60%)]"
          )}
        >
          Loading…
        </div>
      ...
      <div className="space-y-3">
        {!loading && count === 0 ? (
          <div
            className={cn(
              "rounded-2xl border px-4 py-10 text-center",
              "border-border bg-card/80",
              "dark:border-[hsl(40,20%,95%)/10%]"
            )}
          >
            <div className="text-sm font-medium text-foreground dark:text-[hsl(40,20%,92%)]">
